...
template/metric_annual_and_by_matches_correcaminos.html: src/render_metrics_anual_y_por_partido.py
	...
	--color-team=Correcaminos > template/metric_annual_and_by_matches_correcaminos.html
