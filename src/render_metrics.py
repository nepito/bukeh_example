...
plot_ra = figure(x_axis_type='datetime',
...
plot_vj = figure(x_axis_type='datetime',
...
plot_ni = figure(x_axis_type='datetime',
...
rendered = env.get_template("ejemplo_1.html").render(
    ...
    script_ra=script_ra, div_ra=div_ra,
    script_vj=script_vj, div_vj=div_vj,
    script_ni=script_ni, div_ni=div_ni,
    **all_players)
print(rendered)